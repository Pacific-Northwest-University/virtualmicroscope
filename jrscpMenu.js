...
//		- nine javascript files (including jrscpMenu.js)
//		- four PHP files
...
function infoBxMusDwn(mvBtnNode,musEvt) {
	...
	//		calling fucntion), infoBxMvStrt populates glbInfoBxVal, sets color & text
...
function aboutTchScrOpen() {
	...
	abtBodyTxt += "buttons (<font style='font-size: 12px'>on the menu or navigator</font>) will cause the slide ";
	abtBodyTxt += "to repetitively \'step\' across the field-of-view (<font style='font-size: 12px'>in the ";
	abtBodyTxt += "indicated direction</font>) until the finger is lifted.&nbsp; ";
	abtBodyTxt += "This is equivalent to depressing the mouse-button on these controls.</li>";
	abtBodyTxt += "<li style='margin-bottom: 5px'>";
...
function aboutMusCntrlOpen() {
	...
	abtBodyTxt += "located over one of these controls will cause the slide to repetitively ";
	abtBodyTxt += "\'step\' across the field-of-view (<font style='font-size: 12px'>in the direction ";
	abtBodyTxt += "indicated by the arrow</font>) until the mouse\'s button is released.&nbsp; ";
	...
	abtBodyTxt += "button, the size of each \'step\' is increased.</li>";
	abtBodyTxt += "<li style='margin-bottom: 5px'>";
...
function aboutPNWUOpen() {
	...
	abtBodyTxt += "clearkships at hospitals, clinics, and physician's offices located throughout the Pacific Northwest.</p>";
