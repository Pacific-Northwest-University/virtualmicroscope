...
var destArrayMaxNum = 25;  // maximum size of destSldVw[] + purgSldVw[] (~1500 tiles)
...
var glbPnchWhlWait = 250;  // minumum time (in msec) between mouse wheel steps
...
var glbMinPnchDist = 75;  // minimum movement required to fire a pinch/spread
var glbMaxPnchTime = 500;  // maximum time in ms between start and end of a pinch
...
var glbTchMenuFree = true;  // if true, a mouseup event will call tchMenuUnblock() 
